...
func Test_capacityPlugin_OnSessionOpenWithHierarchy(t *testing.T) {
	...
	// pod
	p21 := util.BuildPod("ns1", "p21", "n4", corev1.PodRunning, api.BuildResourceList("1", "1Gi", []api.ScalarResource{{Name: "nvidia.com/a100", Value: "1"}, {Name: "rdma/hca", Value: "1"}}...), "pg21", make(map[string]string), map[string]string{})
	p22 := util.BuildPod("ns1", "p22", "n4", corev1.PodRunning, api.BuildResourceList("1", "1Gi", []api.ScalarResource{{Name: "nvidia.com/a100", Value: "1"}, {Name: "rdma/hca", Value: "1"}}...), "pg22", make(map[string]string), map[string]string{})
	p23 := util.BuildPod("ns1", "p23", "n4", corev1.PodRunning, api.BuildResourceList("1", "1Gi", []api.ScalarResource{{Name: "nvidia.com/a100", Value: "1"}, {Name: "rdma/hca", Value: "1"}}...), "pg23", make(map[string]string), map[string]string{})
	p24 := util.BuildPod("ns1", "p24", "n4", corev1.PodRunning, api.BuildResourceList("1", "1Gi", []api.ScalarResource{{Name: "nvidia.com/a100", Value: "1"}, {Name: "rdma/hca", Value: "1"}}...), "pg24", make(map[string]string), map[string]string{})
	...
	// Test case after project-based reclaim
