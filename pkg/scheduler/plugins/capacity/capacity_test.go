...
func Test_capacityPlugin_OnSessionOpenWithHierarchy(t *testing.T) {
	...
	// case12_queue2 := buildQueueWithParents("case12_queue2", "root", api.BuildResourceList("", "", []api.ScalarResource{{Name: "nvidia.com/a100", Value: "2"}}...), nil)
	// case12_queue21 := buildQueueWithParents("case12_queue21", "case12_queue2", api.BuildResourceList("", "", []api.ScalarResource{{Name: "nvidia.com/a100", Value: "2"}}...), nil)
	// case12_queue22 := buildQueueWithParents("case12_queue22", "case12_queue2", nil, api.BuildResourceList("", "", []api.ScalarResource{}...))
