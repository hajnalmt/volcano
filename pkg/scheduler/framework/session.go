...
type Session struct {
	...
	// scheduling cycle, keyed by node name, so later tasks and actions can reuse
	// them without triggering additional evictions.
	...
	// CreditedEvictions is the set of evicted task UIDs already counted, to
